        ...
        <section id="experience" className="py-20 px-6 relative overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-10 relative z-10">
                ...
                <div className="relative space-y-12">
                    {/* Vertical Line */}
                    <div className="absolute left-4 md:left-8 top-4 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-violet-500 to-transparent opacity-30"></div>
                    ...
                    {experience.map((job, idx) => (
                        ...
                        >
                            {/* Timeline Dot */}
                            <div className="absolute left-[11px] md:left-[27px] top-0 w-3 h-3 md:w-4 md:h-4 rounded-full bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
                            ...
                            <div className="glass hover:bg-white/10 transition-colors duration-500 rounded-3xl p-8 md:p-10 border border-white/5 group">
                                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                                    <div className="flex-1">
                                        <h3 className="text-2xl md:text-3xl font-bold text-blue-500 dark:text-blue-300 mb-2">{job.role}</h3>
