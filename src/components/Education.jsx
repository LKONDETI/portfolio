            ...
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                {education.map((edu, idx) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="glass rounded-3xl p-10 border border-blue-500/20 relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-start gap-8">
                            <div className="p-4 bg-blue-500/10 rounded-2xl border border-blue-500/20 text-blue-500 w-20 h-20 flex items-center justify-center shrink-0">
                                <GraduationCap size={40} />
                            </div>
                            <div className="flex-1">
                                <h3 className="text-3xl font-bold text-[var(--text-primary)] mb-2">{edu.degree}</h3>
                                <p className="text-2xl text-blue-500 font-light mb-4">{edu.school}</p>
                ...
                <div className="pt-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        ${idx % 2 === 0 ? 'border-blue-500' : 'border-violet-500'}
                    `}
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    <div className={`p-3 rounded-xl
                        ${idx % 2 === 0 ? 'bg-blue-500/20 text-blue-500' : 'bg-violet-500/20 text-violet-400'}
                    `}>
                                        <Award size={28} />
                                    </div>
                                    <div>
